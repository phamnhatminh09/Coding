  ...
  if (consultForm && formSuccessBlock) {
    consultForm.addEventListener('submit', (e) => {
      ...
      setTimeout(() => {
        ...
        successText.style.cssText = 'color: var(--text-muted); font-size: 0.95rem; line-height: 1.5; margin-bottom: 20px;';
        successText.append(
          'Cảm ơn ',
        ...
        formSuccessBlock.append(successIcon, successTitle, successText, resetButton);
