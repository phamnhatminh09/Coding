        ...
        const renderPaymentCart = () => {
            if (!cart.length) {
                ...
                cart.forEach((item, index) => {
                    ...
                    decreaseButton.setAttribute("data-cart-idx", String(index));
                    decreaseButton.setAttribute("data-qty-action", "dec");
                    ...
                    increaseButton.setAttribute("data-cart-idx", String(index));
                    increaseButton.setAttribute("data-qty-action", "inc");
                    increaseButton.textContent = "+";
                    quantityRow.appendChild(increaseButton);
                    content.appendChild(quantityRow);
